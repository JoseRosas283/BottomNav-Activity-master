...
public class OlvidarContrasenaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnRestablecer = findViewById(R.id.btnRestablecerContrasena);
        btnRestablecer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new  Intent(OlvidarContrasenaActivity.this, RestablecerContrasenaActivity.class);
